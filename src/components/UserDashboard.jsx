            ...
            {enrolledCourses.length === 0 ? (
                ...
                <SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} spacing={5}>
                    {enrolledCourses.map(course => (
                        <Card key={course.id} borderWidth="1px" borderRadius="lg" boxShadow="lg" overflow="hidden">
                            <CardBody>
                                <Image
                                    src={course.imageUrl}
                                    borderRadius="md"
                                ...
                                <Stack mt={3} spacing={4}>
                                    ...
                                    <HStack spacing={4} mt={3} flexDirection={{ base: "column", sm: "row" }}>
                                        <Link to={`/course/${course.id}`} onClick={() => handleViewCourse(course)} width={{ base: "full", sm: "auto" }}>
                                            <Button colorScheme="blue" variant="outline" width="full" whiteSpace="normal">
                                                {t("View Course")}
                                            </Button>
                                        </Link>
                                        <Link to={`/lesson/${course.id}`} onClick={() => handleWatchLesson(course)} width={{ base: "full", sm: "auto" }}>
                                            <Button colorScheme="green" variant="solid" width="full" whiteSpace="normal">
                                                {t("Watch Lesson")}
                                            </Button>
                                        </Link>
                                    </HStack>
