...
const CourseCatalog = () => {
    ...
    return (
        <Box p={5}>
            ...
            {/* Category Filter */}
            <HStack
                spacing={{ base: 2, sm: 4 }} // Adjust spacing based on screen size
                wrap="wrap" // Allow tags to wrap to the next line on smaller screens
                mb={5}
            >
                {categories.map(category => (
                    <Tag
                        ...
                        m={{ base: 1, sm: 0 }} // Margin adjustment for small screens
                    >
                        {category}
                    </Tag>
                ))}
